...
# Stuffs Gayleer
git clone https://github.com/jfklqdsf/jfgjisd_vendor.git -b dev/16.2 vendor/xiaomi/gale
git clone https://github.com/jfklqdsf/jlkfdhfjklf_kernel.git -b lineage-23.2 kernel/xiaomi/gale
